...
app = Flask(__name__)
# secret = 'dumamay'
# url = 'http://hungf.pythonanywhere.com/' + secret
# Bot connection
...
def send_text(message):
    ...
    try:
        ...
        bot.send_message(chat_id, "An error has occured , contact admin @rongtrang")
...
def how_to_help(message):
    bot.send_message(message.chat.id, "• Contact @rongtrang  👑\n\n• Use /faq for more help")


@bot.message_handler(commands=['faq'])
def how_faq(message):
    bot.send_message(message.chat.id, "• Please contact @rongtrang for tutorial videos, and more helpful information (FAQ > Bot Help). \n\n• Send vouches to @rongtrang \n\n• Buy Here: Scamlords.atshop.io/otp-bot")
